...
FieldWorkerLoginModel fieldWorkerLoginModelFromJson(String str) => FieldWorkerLoginModel.fromJson(json.decode(str));

String fieldWorkerLoginModelToJson(FieldWorkerLoginModel data) => json.encode(data.toJson());
...
class FieldWorkerLoginModel {
  ...
  factory FieldWorkerLoginModel.fromJson(Map<String, dynamic> json) => FieldWorkerLoginModel(
...
class WorkerList {
  ...
  factory WorkerList.fromJson(Map<String, dynamic> json) => WorkerList(
    fieldWorkerId: json["FieldWorkerID"],
    name: json["Name"],
